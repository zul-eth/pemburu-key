...
void generate_and_print_binary() {
    ...
    string priv_key = "101100110101000000011011100101011000111001110100110001";
    ...
    mpz_clears(Gx, Gy, add_x, add_y, NULL);
}
