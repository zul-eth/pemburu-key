...
void* process_data(void* arg) {
    ...
    for (int k = 0; k < 96; ++k) {
      ...
      if (binr.length() == 68 || binr.length() == 73 || binr.length() == 78 || binr.length() == 83 || binr.length() == 88 ||binr.length() == 93 || binr.length() == 98 ||binr.length() == 103 || binr.length() == 108 ||binr.length() == 143 || binr.length() == 118 ||binr.length() == 123 || binr.length() == 159){
        continue;
      }
      for (int i = 0; i < 2; ++i) {
        ...
        check_and_save_private_key(rmd160_hash,private_key);
        num_checked++;
